...
{  
  ...
  //lcd.setBacklight(255);
  lcd.setCursor(0,0);
  lcd.print(make20("Input Range: "));
  lcd.setCursor(0,1);
  if (power_select_known_state==USB_POWER_INPUT_STATE){
    
    lcd.print(make20("USB: 0-26V 3.2A"));
  }
  else{
    lcd.print(make20("P-Jack: 4-15V 3.2A"));
...
void print_four_lines(const char* line1, const char* line2, const char* line3, const char* line4)
{
  ...
  //lcd.setBacklight(255);
  lcd.setCursor(0,0);
  lcd.print(make20(line1));
  lcd.setCursor(0,1);
  lcd.print(make20(line2));
  lcd.setCursor(0,2);
  lcd.print(make20(line3));
  lcd.setCursor(0,3);
  lcd.print(make20(line4));
  ...
  do {
    u8g2.drawStr(0,15,line1);//this is just line 1, line 2, using base 16
...
void display_settings()
{
  ...
  if (sensor_sleep){
    ...
    lcd.print("Sensor sleep: Enabled");
  }
  else{
    lcd.print("Sensor sleep: Disabled");
  }
  lcd.setCursor(0,3);
  lcd.print(rate.c_str());
  #endif
